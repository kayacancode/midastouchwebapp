...
const Contactus = () => {
  ...
  return (
    <div className="   h-screen bg-black">
        ...
        <h1 className = "pt-20 text-white text-3xl text-center  ">Email us  <a href="mailto:info@bookmidastouch.com">info@bookmidastouch.com </a>
  or reach out to us on social media!</h1>

        <footer aria-label="Site Footer" class=" text-center bg-black">
