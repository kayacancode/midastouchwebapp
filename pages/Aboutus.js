...
<section class="my-8 bg-black ">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6  ">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Meet our Talented Djs</h2>
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Get to know our DJs that will make your event a memorable one</p>
      </div> 
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <Image
                  ...
                  className=" w-full rounded-lg" // just an example
                />
                 </div>
                  {/* <Image class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"   layout="fill" // required
                  objectFit="cover src="/johndoe.jpg" alt="Bonnie Avatar" /> */}
              </a>
              <div class="p-5">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <Image
                ...
                />
                  ...
                  {/* <Image class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"  layout="fill" src="/johndoe.jpg"  alt="Jese Avatar"/> */}
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Jese Leos</a>
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <Image
                ...
                />
                  ...
                  {/* <Image class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" layout="fill" src="/johndoe.jpg" alt="Michael Avatar"/> */}
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <Image
                ...
                />
                  ...
                  {/* <Image class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" layout = "fill" src="/johndoe.jpg" alt="Sofia Avatar"/> */}
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Lana Byrd</a>
